...
public class PorXSplitVisitor extends PolardbXParserBaseVisitor<SplitQueryType> {
    public static final AbstractParseTreeVisitor<SplitQueryType> INSTANCE = new PorXSplitVisitor();
