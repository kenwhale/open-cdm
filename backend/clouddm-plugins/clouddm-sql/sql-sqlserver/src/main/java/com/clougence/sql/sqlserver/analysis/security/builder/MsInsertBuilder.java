...
import com.clougence.sql.sqlserver.analysis.security.domain.MsInsertDomain;

public class MsInsertBuilder extends InsertBuilder {

    @Override
    protected RdbInsertDomain getInsertDomain() { return new MsInsertDomain(); }
}
