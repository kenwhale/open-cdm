...
import com.clougence.sql.sqlserver.analysis.security.domain.MsDeleteDomain;

public class MsDeleteBuilder extends DeleteDomainBuilder {

    @Override
    protected RdbDeleteDomain getDeleteDomain() { return new MsDeleteDomain(); }
}
