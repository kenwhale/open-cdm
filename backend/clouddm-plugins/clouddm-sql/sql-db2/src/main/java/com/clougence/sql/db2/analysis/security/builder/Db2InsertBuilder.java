...
import com.clougence.sql.db2.analysis.security.domain.Db2InsertDomain;

public class Db2InsertBuilder extends InsertBuilder {

    @Override
    protected RdbInsertDomain getInsertDomain() { return new Db2InsertDomain(); }
}
