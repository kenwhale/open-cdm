...
@Component
public class DropSchemaBehaviorCallBackHandler extends AbstractBehaviorCallBackHandler {

    @Override
    public void backfill(DmExecSqlAuditDO audit, List<BehaviorRelation> behaviors) {
        for (String schemaPath : affectedPaths(behaviors, TargetType.Schema, BehaviorAction.DROP)) {
            deleteCacheTree(audit, schemaPath);
        }
    }
}
